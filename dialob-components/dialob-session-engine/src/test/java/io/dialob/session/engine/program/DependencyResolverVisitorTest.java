...
import static io.dialob.session.engine.session.command.CommandFactory.updateDisabled;
import static io.dialob.session.engine.session.command.CommandFactory.updateGroupItems;
