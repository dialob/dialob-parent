...
class DateMinusPeriodOperatorTest {
  ...
  void shouldSubtractPeriodFromDate() {
    ...
    assertEquals(LocalDate.of(2023, 10, 20), operator.eval(context));
  }
