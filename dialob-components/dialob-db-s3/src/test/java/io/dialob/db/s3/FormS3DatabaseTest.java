...
class FormS3DatabaseTest {
  ...
  @Test
  void shouldThrowDocumentNotFoundExceptionIfObjectNotFound(final S3Client s3Client) {
    FormS3Database database = new FormS3Database(s3Client, objectMapper, "testii", "forms");
  ...
  @Test
  void shouldGetFalseFromExistsWhenDocumentDoNotExists(final S3Client s3Client) {
    FormS3Database database = new FormS3Database(s3Client, objectMapper, "testii", "forms");
  ...
  @Test
  void shouldBeAbleDeleteNonExistingDocument(final S3Client s3Client) {
    FormS3Database database = new FormS3Database(s3Client, objectMapper, "testii", "forms");
    Assertions.assertFalse(database.exists("00000000-0000-0000-0000-000000000000", "not-exists"));
  ...
  @Test
  void shouldScanBucket(final S3Client s3Client) {
