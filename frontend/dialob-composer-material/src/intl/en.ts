const en = {
  ...
  'dialogs.options.buttons.requirement': 'Requirement',
  'dialogs.options.tabs.label': 'Label',
  'dialogs.options.tabs.description': 'Description',
  'dialogs.options.tabs.rules': 'Rules',
  'dialogs.options.tabs.validations': 'Validations',
