...
import io.dialob.client.spi.ImmutableEntityState;
...
public class PersistenceCommands implements PgSqlConfig.Commands {
  protected final PgSqlConfig config;

  public PersistenceCommands(PgSqlConfig config) {
    super();
    this.config = config;
  }
